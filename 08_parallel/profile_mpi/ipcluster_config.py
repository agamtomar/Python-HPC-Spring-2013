...
c.MPIEngineSetLauncher.mpi_args = ['--bynode', '--bind-to-core']
...
# c.IPClusterStart.work_dir = u'/home/molu8455'
...
# variable IPYTHONDIR.
# c.IPClusterStart.ipython_dir = u'/home/molu8455/.ipython'
...
# Set the working dir for the process.
# c.IPClusterEngines.work_dir = u'/home/molu8455'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPClusterEngines.ipython_dir = u'/home/molu8455/.ipython'
...
# c.LocalControllerLauncher.controller_cmd = ['/projects/molu8455/software/anaconda/1.4.0/bin/python', '-c', 'from IPython.parallel.apps.ipcontrollerapp import launch_new_instance; launch_new_instance()']
...
# c.LocalEngineLauncher.engine_cmd = ['/projects/molu8455/software/anaconda/1.4.0/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
...
# command to launch the Engine.
# c.LocalEngineSetLauncher.engine_cmd = ['/projects/molu8455/software/anaconda/1.4.0/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
...
#c.MPILauncher.mpi_args = ['--bynode, --bind-to-core']
...
# The command line arguments to pass to mpiexec.
#c.MPIControllerLauncher.mpi_args = ['--bynode --bind-to-core']

# The mpiexec command to use in starting the process.
#c.MPIControllerLauncher.mpi_cmd = ['mpirun']



# command to launch the Engine.
# c.MPIEngineSetLauncher.engine_cmd = ['/projects/molu8455/software/anaconda/1.4.0/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
...
# Popen command to launch ipcontroller.
# c.SSHControllerLauncher.controller_cmd = ['/projects/molu8455/software/anaconda/1.4.0/bin/python', '-c', 'from IPython.parallel.apps.ipcontrollerapp import launch_new_instance; launch_new_instance()']
...
# command to launch the Engine.
# c.SSHEngineLauncher.engine_cmd = ['/projects/molu8455/software/anaconda/1.4.0/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
...
# command to launch the Engine.
# c.SSHEngineSetLauncher.engine_cmd = ['/projects/molu8455/software/anaconda/1.4.0/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
